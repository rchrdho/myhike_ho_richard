...
doAll(); // this executes all of the following functions above, commented out redundancies below.
...
function displayCardsDynamically(collection) {
    ...
    db.collection(collection)
        .orderBy("hike_time","asc") // NEW LINE: what do you want to sort by?
        ...
        .then(allHikes=> {
            ...
            allHikes.forEach(doc => { //iterate thru each doc
                ...
                //NEW LINE: update to display length, duration, and last updated
